...
export class MenuDocument {
    ...
    **/
    list = () => {
        ...
        let table = $('#dataTableMenuDocument').DataTable({
            "processing": true,
            "serverSide": true,
            "bDestroy": true,
            "bJQueryUI": true,
            ...
            "buttons": [
                {
                    ...
                    action: function (e, dt, node, config) {
                        Swal.fire({
                            title: 'Add Menu Document',
                            html: `
                            <form id="menu_document_add" data-parsley-validate>
                                <div class="row">
                                    <div class="col-4">
                ...
                },
                {
                    ...
                    action: function (e, dt, node, config) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                $.ajax({
                                    url: api_urls["menu_document_list"] + data[0].uuid + '/',
                                    type: "DELETE",
                                    success: function (response) {
                                        Swal.fire(
                                            'Deleted!',
            ...
            "ajax": {
                'url': api_urls["menu_document_list"],
                'type': 'GET',
        ...
        $('#dataTableMenuDocument tbody').on('click', 'tr', function () {
        ...
        $('#dataTableMenuDocument tbody').on('dblclick', 'tr', function () {
    ...
    edit_form_value_set = (data_table, _uuid) => {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                Swal.fire({
                    title: 'Edit Menu Document',
                    html: `
                <form id="menu_document_edit" data-parsley-validate>
                    <div class="row">
                        <div class="col-4">
                ...
                populate($('#menu_document_edit'), response.data);
            },
            error: function (response) {
