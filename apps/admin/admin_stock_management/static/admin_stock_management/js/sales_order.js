...
class SalesOrder {
    ...
    **/
        ...
        let table = $('#salesOrderDataTable').DataTable({
            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    "searchable": true,
                    "render": function (data, type, row, meta) {
                        let paid = 'Complete <i class="fa fa-check" aria-hidden="true" style="color:green"></i>'
                        if (!row.is_paid) {
                            paid = 'Incomplete <i class="fa fa-times-circle" aria-hidden="true" style="color:red"></i>'
                        }
                        return paid;
                    },
                },
    ...
    table_row = `<tr>
                    ...
                    <td><input class="delivered" type="number" value="0"></td>
    ...
    **/
    select_sidebar_option = () => {
        ...
        $('#sidebar_option_stock_management_sales_order').addClass('active');
    };
    ...
    edit_page_data_set = () => {
        ...
        $.ajax({
            ...
            success: function (resp) {
                ...
                $('#delivery_cost').text(data.delivery_cost || "00")
                ...
                $.each(data.products, function (i, v) {
                    rows += `<tr>
                        ...
                        <td><input class="delivered" type="number" value="${v.delivered}"></td>
                        ...
                        <!--<td class="remove_row">&nbsp;&nbsp;&nbsp;&nbsp;<i class='fas fa-cloud-upload-alt'></i></td>-->
                        <td 
                            class="update_stock" 
                            data-so="${uuid}"
                            data-pid="${v.id}"
                ...
                // disable modification as SO is not updatable from this page
    ...
    **/
    ...
    update_stock = () => {
        ...
        $(document).on('click', '.update_stock', function (e) {
            ...
            $('#modal_delivered').val(data.delivered);
        ...
        $(document).on('click', '#update_stock_submit_button_modal', function (e) {
            ...
            if (parseFloat($('#modal_current_delivered').val()) < 1) {
                notify('Current delivered must be greater than 0', 'error', 5000);
                return
            }
            ...
            if(total_warehouse_stock_added != parseFloat($('#modal_current_delivered').val())) {
                notify("Warehouse must have equal stock in current delivered", 'error', 5000);
                return
            }
            if(parseFloat($('#modal_current_delivered').val()) > parseFloat($('#modal_pending').val())) {
                notify("Current delivered can't have stock more than pending", 'error', 5000);
                return
            }
            if (invalid_entry) {
                notify("Warehouse deliverable can't be more than current stock", 'error', 5000);
                return
            }
            ...
            let data = {
                ...
                current_delivered: $('#modal_current_delivered').val(),
                uuid: uuid,
...
*                       EDIT PAGE UPDATE STOCK SET WAREHOUSE
    ...
    **/
    disable_edit_page_modification = () => {
        ...
        $('#update_stock_modal #modal_current_delivered, .warehouse_sub_stock').prop('readonly', false)
    }
