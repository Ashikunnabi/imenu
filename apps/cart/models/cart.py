...
class Cart(BaseModel):
    user = models.ForeignKey(User, on_delete=models.PROTECT, related_name="carts", blank=True, null=True)
    table = models.ForeignKey(Table, on_delete=models.PROTECT, related_name="carts", blank=True, null=True)
