...
w3kit = function () {
	...
	var handleSelectedItem = function () {
		...
		$(document).on("click", ".item-bookmark", function (e) {
			...
			var itemIndex = selected_items.indexOf(itemToToggle);
